    ...
    const handleProcess = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                `${API_CONFIG.BASE_URL}/novedades-nomina/otros_gerencia/preview`,
                formData,
            );
            setData(res.data);
            setWarningsDetalle(res.data.warnings_detalle || []);
    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <Title variant="h4" weight="bold">OTROS GERENCIA – Preview</Title>
                    <Text color="text-secondary">OTROS / OTROS GERENCIA</Text>
                </div>
            </div>
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <Text size="sm" color="text-secondary">Ver archivos cargados anteriormente para OTROS GERENCIA</Text>
                </div>

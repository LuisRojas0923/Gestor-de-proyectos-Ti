                                        ...
                                        <table className="w-full text-[11px] border-collapse">
                                            <thead className="sticky top-0 z-10">
                                                <tr className="bg-[var(--color-primary-900)] text-white shadow-md">
                                                    <th className="text-center py-3 px-4 font-bold uppercase tracking-wider w-10 border-b border-white/5 border-r border-white/5 first:rounded-tl-xl">#</th>
                                                    <th className="text-center py-3 px-4 font-bold uppercase tracking-wider w-24 border-b border-white/5 border-r border-white/5">
                                                    ...
                                                    <th className="text-center py-3 px-4 font-bold uppercase tracking-wider w-64 border-b border-white/5 last:rounded-tr-xl">
                                                        <div className="flex items-center justify-center gap-1">
                                                            <span>CONCEPTO</span>
                                                            <FilterDropdown 
                                            ...
                                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                                {filteredRows.map((row, i) => (
                                                    <tr key={i} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                                                        ...
                                                        <td className="p-2 border-r border-slate-50 w-[232px] text-center">{row.nombre_asociado}</td>

                            ...
                            <table className="w-full text-[11px] border-collapse">
                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                    {filteredRows.map((row, i) => (
                                        <tr onContextMenu={(e) => handleContextMenu(e, row)} key={`${row.cedula}-${i}`} className={`hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors cursor-context-menu ${row.estado_erp === "EXCEPTUADO" ? "bg-slate-100/80 opacity-60 line-through" : ""}`}>

    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <Title variant="h4" weight="bold">BOGOTÁ LIBRANZA – Preview</Title>
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <Text size="sm" color="text-secondary">Ver archivos cargados anteriormente para BOGOTA LIBRANZA</Text>
                </div>

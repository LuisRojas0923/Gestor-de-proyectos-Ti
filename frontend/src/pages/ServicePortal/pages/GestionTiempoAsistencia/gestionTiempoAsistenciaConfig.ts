...
export const OPCIONES_TIEMPO_ASISTENCIA: ReadonlyArray<OpcionTiempoAsistencia> = [
  ...
  { id: 'planificador', seccion: 'asistencia', titulo: 'Planificador semanal', descripcion: 'Prepara horarios, novedades y órdenes de trabajo por semana.', ruta: '/service-portal/horas-extras/planificador', permiso: 'nomina_horas_extras.planificar', icono: CalendarCheck, moduloEstado: 'nomina_horas_extras' },
  { id: 'plantillas', seccion: 'asistencia', titulo: 'Plantillas de horario', descripcion: 'Diseña y aplica jornadas semanales reutilizables.', ruta: '/service-portal/horas-extras/plantillas', permiso: 'nomina_horas_extras.plantillas_horario.administrar', icono: CalendarClock },

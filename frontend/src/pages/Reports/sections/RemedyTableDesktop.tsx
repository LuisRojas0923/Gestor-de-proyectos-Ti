...
interface RemedyTableDesktopProps {
  darkMode: boolean;
...
const RemedyTableDesktop: React.FC<RemedyTableDesktopProps> = ({
  darkMode,
  cases,
  visibleColumns,
  onRowDoubleClick
            ...
            cases.map((caseItem) => (
              ...
              >
                ...
                {visibleColumns.estado && (
                  <td className="px-4 py-3 text-sm">
                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                      caseItem.general_status === 'en_curso' ? 
                        'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400' :
...
export default RemedyTableDesktop;

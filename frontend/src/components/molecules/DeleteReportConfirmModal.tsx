...
const DeleteReportConfirmModal: React.FC<DeleteReportConfirmModalProps> = ({
    isOpen,
    onClose,
    onConfirm,
    reportCode,
        ...
        <Modal
            ...
            title={
                <div className="flex items-center gap-2 text-red-600">
                    <Trash2 size={20} />
                    <Text as="span" weight="bold">Eliminar Reporte</Text>
                </div>
            }
        >
            <div className="space-y-6">
                <div className="flex flex-col items-center text-center space-y-3">
                    ...
                    <Title variant="h4" className="text-red-600 font-black uppercase tracking-tight px-4">
                        ¿ELIMINAR ESTE REPORTE?
                    </Title>
                    <div className="space-y-1">
                        <Text className="text-slate-500 dark:text-neutral-400">
                            Estás a punto de eliminar permanentemente el reporte de gastos
                        </Text>
                        {reportCode && (
                            <Text weight="bold" className="text-red-700 dark:text-red-400 bg-red-100 dark:bg-red-900/30 px-3 py-1 rounded-lg inline-block text-lg">
                                {reportCode}
                            </Text>
                        )}
                    </div>

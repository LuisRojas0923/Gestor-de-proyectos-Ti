                ...
                {currentType === 'categorical' ? (
                    <>
                        ...
                        >
                            ...
                            <Text variant="caption" weight="bold" align={optionTextAlign} className="min-w-0 flex-1 text-[11px]">Seleccionar Todos</Text>
                        </Button>
                        ...
                        <div className="py-1">
                            {filteredOptions.map(opt => (
                                ...
                                >
                                    ...
                                    <Text variant="caption" align={optionTextAlign} className="min-w-0 flex-1 text-[11px] truncate">{opt.label || '(Vacío)'}</Text>
                                </Button>
                            ))}
                        </div>
                    </>

...
def extraer_planillas_regionales_1q(archivos_binarios: List[bytes]) -> Tuple[List[Dict[str, Any]], Dict[str, Any], List[str]]:
    """
    ...
    - Agrupación: Por CÉDULA, EMPLEADO, NOVEDAD, EMPRESA, SUCURSAL
    - Cálculos:
        - HORAS: suma de CANT. HORAS
        - DIAS: suma de CANTIDAD
    """
    warnings = []
    ...
    for i, content in enumerate(archivos_binarios):
        try:
            # Leer el archivo excel para obtener nombres de hojas
            ...
            # El usuario indica "filtrar los diferentes a estos valores", lo que significa excluir estos y dejar el resto
            ...
            for _, row in df.iterrows():
                ...
                # Key para agrupar: (cedula, empleado, novedad, empresa, sucursal)
            ...
            logger.error(f"Error procesando archivo de Planillas Regionales: {e}")

...
async def datos_planillas_1q(mes: int, anio: int, session: AsyncSession = Depends(obtener_db)):
...
async def datos_planillas_2q(mes: int, anio: int, session: AsyncSession = Depends(obtener_db)):

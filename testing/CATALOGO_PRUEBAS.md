...
| **Horas Extras OT Horarios ERP - automático** | `test_horas_extras_ot_horarios.py` | Contrato SQL/mock paginado de `OThorarios`, selección determinista, categorías obligatorias, comodines escapados, límites HTTP, 401/403, total fuera de rango, cierre de sesión ERP y degradación controlada a 503. | ✅ 18 PASSED / 1 SKIPPED el 2026-07-22 |
...
| **Horas Extras OT Horarios ERP** | `tests/horasExtrasOtHorariosService.test.ts` | URL, parámetros codificados y bearer token del selector OT respaldado por `OThorarios`. | ✅ 1 PASSED |
...
| **DataTable planificador** | `components/molecules/__tests__/DataTable.test.tsx` | Scroll horizontal con y sin resultados, filtros agrupados, orden por subfiltro y semántica accesible del orden. | ✅ 14 PASSED el 2026-07-21 |
